...
public class SPUM_Manager : MonoBehaviour
{
    ...
    public void SetHorse(bool value, string name)
    {
        ...
        //    _unitObjSet.transform.parentModel.localScale = new Vector3(0.7f,0.7f,0.7f);
        ...
        //    _unitObjSet.transform.parentModel.localScale = new Vector3(0.9f,0.9f,0.9f);
